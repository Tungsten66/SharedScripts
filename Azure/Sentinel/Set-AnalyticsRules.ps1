...
Updated : 27-December-2023 (Charbel Nemnom)
          10-April-2024 Nick OConnor - Added Environment param so script will work across multiple environments after updating AGC1 and AGC2 placeholders.
...
param (
  ...
  [ValidateSet("AzureCloud", "AzureUSGovernment", "AGC1", "AGC2")]
  [String]$Environment
)
...
$contentURI = "$CloudURI/subscriptions/$subscriptionid/resourceGroups/$resourceGroupName/providers/Microsoft.OperationalInsights/workspaces/$workspaceName/providers/Microsoft.SecurityInsights/contentProductPackages?api-version=2023-09-01-preview"
...
$contentURI = "$CloudURI/subscriptions/$subscriptionid/resourceGroups/$resourceGroupName/providers/Microsoft.OperationalInsights/workspaces/$workspaceName/providers/Microsoft.SecurityInsights/contentTemplates?api-version=2023-09-01-preview"
$contentResponse = (Invoke-RestMethod $contentURI -Method 'GET' -Headers $authHeader).value
...
foreach ($contentTemplate in $contentTemplates) {
  ...
  $ruleTemplateURI = "$CloudURI/subscriptions/$subscriptionid/resourceGroups/$resourceGroupName/providers/Microsoft.OperationalInsights/workspaces/$workspaceName/providers/Microsoft.SecurityInsights/contentTemplates/$($ruleName)?api-version=2023-09-01-preview"
